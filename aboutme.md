...
As part of DARPA's High-Assurance Cyber Military Systems (HACMS) programme, Peter led a team that designed and formally verified protocols subsequently deployed in operational unmanned aircraft built by Boeing. In 2023, DARPA honoured this work with its [Game Changer Award](https://www.darpa.mil/news-events/2023-01-24), recognising its profound and lasting impact on national security. He currently leads a AUD$1 million project funded by Australia's Defence Science and Technology Group, developing generic frameworks for verifying concurrent data structures used to protect sensitive infrastructure from cyber attacks.
...
Peter is the elected Vice Chair of the [International Federation for Information Processing (IFIP) Technical Committee 2](https://www.ifip.org) — Software: Theory and Practice, an international body comprising 17 Working Groups and over 450 researchers and ICT professionals. He also serves as elected Chair of [IFIP Working Group 2.1](https://ifipwg21wiki.cs.kuleuven.be/IFIP21/WebHome) on Algorithmic Languages and Calculi and as an elected member of [IFIP Working Group 2.3](https://ifip-tc2-wg23.paluno.uni-due.de) on Programming Methodology.

He serves on the editorial board of the [Journal of Logical and Algebraic Methods in Programming (JLAMP)](http://www.journals.elsevier.com/journal-of-logical-and-algebraic-methods-in-programming) and on the steering committees of [RAMiCS](http://ramics-conference.org/) and [MARS](http://mars-workshop.org/) — the latter of which he founded in 2015. He is also a member of the Formal Methods Europe (FME) Industry Committee.
